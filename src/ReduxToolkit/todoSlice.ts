...
const INITIAL_STATE: Array<ITODO> = getFromLocalStorage(STORAGE_TODOS_KEY) ??[
    {id: generateID(), title: 'title test 1', description: 'description', is_done: false},
    {id: generateID(), title: 'title test 2', description: 'description', is_done: false},
    {id: generateID(), title: 'title test 3', description: 'description', is_done: false},
    {id: generateID(), title: 'title test 4', description: 'description', is_done: false},
];
...
const TODO_SLICE = createSlice({
    ...
    reducers:{
        createAndPushNewTODOAtTop: (CURRENT_STATE, ACTION: PayloadAction<Pick<ITODO, "title" | "description">>) => {
...
export const { clearAllTODOs, createAndPushNewTODOAtTop, deleteTODOById, toggleIsDoneStateAtGivenId, updateTODOById} = TODO_SLICE.actions
